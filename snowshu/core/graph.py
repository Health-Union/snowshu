...
class SnowShuGraph:
    ...
    def catalog_difference(source_graph: Union["SnowShuGraph", networkx.Graph],
        ...
        """ Builds a directed graph per replica config.
            ...
            Args:
                source_graph: :class:`SnowShuGraph <snowshu.core.graph.SnowShuGraph>` another class instance
                    to find the difference with.
                target_catalog: :class:`SnowShuGraph <snowshu.core.graph.SnowShuGraph>` another class instance
                    to find the difference with.
