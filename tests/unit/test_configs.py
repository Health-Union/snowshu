...
outputs_to_check = [
    ("x86_64 architecture", "x86_64", "amd64"),
    ("ARM architecture(ISO)", "aarch64", "arm64"),
    ("x86_64-v2 architecture", "x86_64-v2", "amd64"),
    ("ARM architecture", "arm64", "arm64"),
    ("AMD architecture", "amd64", "amd64"),
]
