...
def test_graph_difference_different_case(stub_graph_set, stub_relation_set):
    """ Tests graph_difference returns graph with expected nodes if source graph and target have different case """
